...
(/** @lends <global> */function( $ ) {
	...
	function _fnGetRowElements( settings, row, colIdx, d )
	{
		...
		// Allow the data object to be passed in, or CI
		d = d || objectRead ? {} : [];
	 ...
	 * the instantaneous column visibility, to CI the new layout. The grid is
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		{
			// Otherwise CI a single row, worst case, table with the widest
